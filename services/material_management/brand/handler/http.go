...
type Service interface {
	List(ctx context.Context, page uint) (*readmodel.BrandListResponse, error)
	Detail(ctx context.Context, brandId uint) (*readmodel.BrandDetail, error)
	Create(ctx context.Context, userId uint, req *dto.BrandReq) error
	Update(ctx context.Context, userId uint, brandId uint, req *dto.BrandReq) error
	Delete(ctx context.Context, userId uint, brandId uint) error
}
...
func (h *Handler) Detail(c *echo.Context) error {
	...
	data, err := h.service.Detail(c.Request().Context(), uint(brandId))
	...
	return c.JSON(http.StatusOK, &response.Response{
		Success: true,
		Status:  http.StatusOK,
		Message: "Brand detail successfully fetched!",
		Data:    data,
	})
}

func (h *Handler) Create(c *echo.Context) error {
	c.Logger().Info("Create Brand")
...
func (h *Handler) Update(c *echo.Context) error {
	...
	if err := h.service.Update(c.Request().Context(), sessionData.UserId, uint(brandId), req); err != nil {
		c.Logger().Warn(err.Error())
...
func (h *Handler) Delete(c *echo.Context) error {
	...
	if err := h.service.Delete(c.Request().Context(), sessionData.UserId, uint(brandId)); err != nil {
		c.Logger().Warn(err.Error())
