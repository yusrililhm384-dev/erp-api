...
type Service interface {
	Create(ctx context.Context, userId uint, req *dto.CreateVendorReq) error
	Update(ctx context.Context, userId uint, vendorId uint, req *dto.UpdateVendorReq) error
	Delete(ctx context.Context, userId, vendorId uint) error
	Detail(ctx context.Context, vendorId uint) (*readmodel.VendorDetail, error)
	List(ctx context.Context, page uint) (*readmodel.VendorListResponse, error)
}
...
func (h *Handler) List(c *echo.Context) error {
	...
	if err != nil {
		...
		if errors.Is(err, errs.ErrVendorNotFound) {
	...
	return c.JSON(http.StatusOK, &response.Response{
		...
		Message: "Vendor list successfully fetched!",
...
func (h *Handler) Detail(c *echo.Context) error {
	...
	data, err := h.service.Detail(c.Request().Context(), uint(vendorId))
	...
	return c.JSON(http.StatusOK, &response.Response{
		Success: true,
		Status:  http.StatusOK,
		Message: "Vendor detail successfully fetched!",
		Data:    data,
	})
}

func (h *Handler) Delete(c *echo.Context) error {
	c.Logger().Info("Delete Vendor")
	...
	if err := h.service.Delete(c.Request().Context(), sessionData.UserId, uint(vendorId)); err != nil {
		c.Logger().Warn(err.Error())
...
func (h *Handler) Update(c *echo.Context) error {
	...
	if err := h.service.Update(c.Request().Context(), sessionData.UserId, uint(vendorId), req); err != nil {
		c.Logger().Warn(err.Error())
