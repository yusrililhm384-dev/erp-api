...
type Vendor struct {
	...
	PaymentTermID uint         `json:"payment_term_id" gorm:"index;not null"`
	PaymentTerm   *PaymentTerm `json:"payment_term" gorm:"foreignKey:PaymentTermID"`
...
type VendorContact struct {
	...
	Phone     string  `json:"phone" gorm:"type:varchar(20);not null;uniqueIndex:idx_vendor_phone_active,where:deleted_at IS NULL"`
	...
	IsPrimary bool    `json:"is_primary" gorm:"type:boolean;default:false"`
}
