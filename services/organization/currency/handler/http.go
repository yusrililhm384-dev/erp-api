...
type Service interface {
	List(ctx context.Context, page uint) (*readmodel.CurrencyListResponse, error)
	Detail(ctx context.Context, currencyId uint) (*readmodel.CurrencyDetail, error)
	Create(ctx context.Context, userId uint, req *dto.CreateCurrencyReq) error
	Update(ctx context.Context, userId uint, currencyId uint, req *dto.UpdateCurrencyReq) error
	Delete(ctx context.Context, userId uint, currencyId uint) error
}
...
func (h *Handler) List(c *echo.Context) error {
	...
	return c.JSON(http.StatusOK, &response.Response{
		...
		Message: "Currency list successfully fetched!",
...
func (h *Handler) Detail(c *echo.Context) error {
	...
	data, err := h.service.Detail(c.Request().Context(), uint(currencyId))
	...
	return c.JSON(http.StatusOK, &response.Response{
		Success: true,
		Status:  http.StatusOK,
		Message: "Currency detail successfully fetched!",
		Data:    data,
	})
}

func (h *Handler) Create(c *echo.Context) error {
	c.Logger().Info("Create Currency")
	...
	if err := h.service.Create(c.Request().Context(), sessionData.UserId, req); err != nil {
		...
		if errors.Is(err, errs.ErrDuplicateError) {
			return echo.NewHTTPError(http.StatusConflict, "Currency already exists!")
		}
...
func (h *Handler) Update(c *echo.Context) error {
	...
	if err := h.service.Update(c.Request().Context(), sessionData.UserId, uint(currencyId), req); err != nil {
		c.Logger().Warn(err.Error())
...
func (h *Handler) Delete(c *echo.Context) error {
	...
	if err := h.service.Delete(c.Request().Context(), sessionData.UserId, uint(currencyId)); err != nil {
		c.Logger().Warn(err.Error())
